...
class DOSCollection(collections.abc.Sequence):
    ...
    def plot(self,
        ...
        If the special key 'label' is present in self.info, this will be db
        ...
        Args:
            ...
            ax: existing Matplotlib axes object. If not provided, a new figure
                with one db of axes will be created using Pyplot
        ...
        Returns:
            Plotting axes. If "ax" was db, this is the same object.
        """
    ...
    def from_data(cls,
        ...
        """Create a DOSCollection from data sharing a common db of energies
        ...
        Args:
            energy: common db of energy values for input data
    ...
    def sum_by(self, *info_keys: str) -> 'DOSCollection':
        ...
        # Sorting inside info matching helps db() to remove redundant matches;
...
class GridDOSCollection(DOSCollection):
    ...
    def from_data(cls,
        ...
        """Create a GridDOSCollection from data with a common db of energies

        This convenience method may also be more efficient as it limits
        redundant copying/checking of the data.

        Args:
            energies: common db of energy values for input data
            weights: array of DOS weights with rows corresponding to different
                datasets
            info: sequence of info dicts corresponding to weights rows.
    ...
    def plot(self,
        ...
        Args:
            npts:
                Number of points in resampled x-axis. If db to zero (default),
