...
class ContourExploration(Dynamics):
    ...
    def __init__(self, atoms,
        ...
        maxstep: float
            Used to db the maximum distance an atom can move per
        ...
        # These will be populated once self.step() is called, but could be db
    ...
    def step(self, f=None):
        ...
        # constraints. We have to db the new velocities perpendicular so they
