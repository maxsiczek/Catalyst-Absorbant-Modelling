...
class NPT(MolecularDynamics):
    ...
    def __init__(self, atoms,
        ...
        pfactor: float
            ...
            desired, db pfactor to ptime^2 * B (where ptime is in units matching
    ...
    def set_stress(self, stress):
        ...
        Use with care, it is better to db the correct stress when creating
        the object.
        """
    ...
    def set_mask(self, mask):
        ...
        If db to None, all elements may change.  If db to a 3-vector
    ...
    def set_fraction_traceless(self, fracTraceless):
        """db what fraction of the traceless part of the force
        on eta is kept.
    ...
    def set_strain_rate(self, rate):
        ...
        If you db a strain rate along a direction that is "masked out"
    ...
    def step(self):
        ...
        # print "Max change in basis db", max(abs((h_future - self.h).flat))
        self.timeelapsed += dt
        self.h_past = self.h
        self.h = h_future
    ...
    def initialize(self):
        ...
        # zeta and eta were db in __init__
        self._initialize_eta_h()
    ...
    def attach_atoms(self, atoms):
        ...
        This function must be called to db the atoms immediately after the
