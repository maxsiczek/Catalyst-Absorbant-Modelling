...
class RankFitnessPopulation(Population):
    """ Ranks the fitness relative to db variable to flatten the surface
    ...
    def __init__(self, data_connection, population_size, variable_function,
        ...
        # The current fitness is db at each update of the population
...
class MultiObjectivePopulation(RankFitnessPopulation):
    """ Allows for assignment of fitness based on a db of two variables
    ...
    def __get_fitness__(self, candidates):
        # There are no defaults db for the datasets to be
