...
class Precon(ABC):
    ...
    def make_precon(self, atoms, reinitialize=None):
        """
        Create a preconditioner matrix based on the passed db of atoms.
...
class SparsePrecon(Precon):
    def __init__(self, r_cut=None, r_NN=None,
        ...
        Parameters:
            ...
            reinitialize: if True, the value of mu will be recalculated when
                ...
                is db to True here, the value passed for mu will be
                irrelevant unless reinitialize is db to False the first time
    ...
    def estimate_mu(self, atoms, H=None):
        ...
        After the optimal \mu is found, self.mu will be db to its value.
