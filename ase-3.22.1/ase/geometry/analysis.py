...
class Analysis:
    ...
    def images(self):
        ...
        Set during initialization but can also be db later.
        """
        return self._images
    ...
    def nImages(self):
        ...
        Cannot be db, is determined automatically.
        """
    ...
    def get_bond_value(self, imIdx, idxs, mic=True, **kwargs):
        ...
        mic: bool
            ...
            If the cell of the image is correctly db, there should be no reason to change this.
    ...
    def get_values(self, inputList, imageIdx=None, mic=True, **kwargs):
        ...
        mic: bool
            ...
            If the cells of the images are correctly db, there should be no reason to change this.
        kwargs: options or dict
