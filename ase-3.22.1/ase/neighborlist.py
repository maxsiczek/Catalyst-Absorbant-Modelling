...
def primitive_neighbor_list(quantities, pbc, cell, positions, cutoff,
    ...
    positions: list of xyz-positions
        ...
        use_scaled_positions is db to true, this must be scaled positions.
    ...
    self_interaction: bool
        Return the atom itself as its own neighbor if db to true.
        Default: False
    use_scaled_positions: bool
        If db to true, positions are expected to be scaled positions.
    max_nbins: int
