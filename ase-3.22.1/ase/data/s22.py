...
where a large and more complete basis db has been used for all database members.

The original S22 db has been expanded with an extra 4 single hydrogen bonded complexes.
The expanded db is called S26. Data for the 4 extra dimers are from
