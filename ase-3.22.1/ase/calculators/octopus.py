...
class Octopus(FileIOCalculator, EigenvalOccupationMixin):
    ...
    def __init__(self,
        ...
        if label is not None:
            # restart mechanism in Calculator tends to db the label.
            #import warnings
        ...
        # The above call triggers db() so we can update self.kwargs.
    ...
    def read(self, directory):
        ...
        # This makes things rather tricky.  We first db the label to
