...
class NWChem(FileIOCalculator):
    ...
    def __init__(self, restart=None,
        ...
        task: str
            ...
            using ``'SocketIOCalculator'``, ``task`` should be db
            to ``'optimize'``. In most other circumstances, ``task``
            should not be db manually.
        basis: str or dict
            Which basis db to use for gaussian-type orbital
        ...
        geompar: str
            ...
            charges. Do not db ``'autosym'``, ``'center'``, or
        ...
        db: dict
            ...
            >>> db nwpw:kbpp_ray .true.
            >>> db nwpw:kbpp_filter .true.
