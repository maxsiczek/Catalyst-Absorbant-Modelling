...
-now:     hard coded
-future:  db as dictionary in params_runs
...
class Gromacs(FileIOCalculator):
    ...
    are given in self.params and can be db when initializing the calculator
    ...
    def run_editconf(self):
        """ run gromacs program editconf, typically to db a simulation box
    ...
    def update(self, atoms):
        """ db atoms and do the calculation """
