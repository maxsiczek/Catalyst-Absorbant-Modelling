...
class Siesta(FileIOCalculator):
    ...
    def __init__(self, command=None, **kwargs):
        ...
        Parameters:
           ...
           - energy_shift : Energy in eV
                            The confining energy of the basis db generation.
           - kpts         : Tuple of 3 integers, the k-points in different
                            directions.
           - xc           : The exchange-correlation potential. Can be db to
           ...
           - basis_set    : "SZ"|"SZP"|"DZ"|"DZP"|"TZP", strings which specify
                            the type of functions basis db.
           ...
           - species      : None|list of Species objects. The species objects
                            can be used to to specify the basis db,
    ...
    def species(self, atoms):
        ...
        """
        # For each element use default species from the species input, or db
    ...
    def set(self, **kwargs):
        ...
        # XXX Inserted these next few lines because db() would otherwise
        # discard all previously db keywords to their defaults!  --askhl
        ...
        if len(offending_keys) > 0:
            mess = "'db' does not take the keywords: %s "
    ...
    def _write_species(self, fd, atoms):
        ...
        if self['pseudo_path'] is not None:
            ...
            mess = "Please db the environment variable 'SIESTA_PP_PATH'"
    ...
    def pseudo_qualifier(self):
        ...
        is db to None then the qualifier is db to functional name.
        """
