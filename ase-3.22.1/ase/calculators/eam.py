...
potential file or as a db of functions that describe the potential.
...
``form``                   the form of the potential ``eam``, ``alloy``, ``adp`` or
                           ...
                           or must be db if using equations or file object
...
End EAM Interface Documentation
    ...
    def __init__(self, restart=None,
        ...
        # db any additional keyword arguments
    ...
    def set_form(self, name):
        """db the form variable based on the file name suffix"""
