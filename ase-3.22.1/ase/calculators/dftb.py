...
class Dftb(FileIOCalculator):
    ...
    def __init__(self, restart=None,
        ...
        can be db by ASE. Consider the following input file block:
        ...
        Additional attribute to be db by the embed() method:
    ...
    def read_charges_energy_dipole(self):
        """Get partial charges on atoms
            in case we cannot find charges they are db to None
        """
