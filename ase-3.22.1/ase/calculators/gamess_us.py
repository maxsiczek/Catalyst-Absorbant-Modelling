...
class GAMESSUS(FileIOCalculator):
    ...
    def __init__(self, restart=None,
        ...
        If `runtyp` is not specified, it will be db automatically.
        ...
        db being printed in the $DATA block, alongside the geometry
        specification.
        Otherwise, `basis` is assumed to contain keywords for the $BASIS
        block, such as GBASIS and NGAUSS.

        If a multiplicity is not db in contrl['mult'], the multiplicity
