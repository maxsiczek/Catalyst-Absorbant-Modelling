...
class AutoNEB:
    ...
    The stages are:
        1) Define a db of images and name them sequentially.
    ...
    space_energy_ratio: float
        ...
        A space_energy_ratio db to 1 will only considder geometric gabs
        while one db to 0 will result in only images for energy
        resolution.
    ...
    When doing the i'th NEB optimization a db of files
    ...
    def which_images_to_run_on(self):
        """Determine which db of images to do a NEB at.
