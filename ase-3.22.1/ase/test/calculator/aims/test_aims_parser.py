...
------------------------------------------------------------
  ...
  **Attention: initial geometry.in file will be ignored!
  ...
  Target number of points in a grid batch is not db. Defaulting to  100
  Method for grid partitioning is not db. Defaulting to parallel hash+maxmin partitioning.
  Batch size limit is not db. Defaulting to    200
  ...
  Pulay mixer: Number of relevant iterations not db.
  Defaulting to    8 iterations.
  Pulay mixer: Number of initial linear mixing iterations not db.
  Defaulting to    0 iterations.
  Work space size for distributed Hartree potential not db.
  Defaulting to   0.200000E+03 MB.
  Mixing parameter for charge density mixing has not been db.
  ...
  Analytical stress calculation: scf convergence accuracy of stress not db.
                                 Analytical stress self-consistency will not be checked explicitly.
                                 Be sure to db other criteria like sc_accuracy_rho tight enough.
  Force calculation: scf convergence accuracy of forces not db.
  ...
  Maximum # of iterations to find E_F not db. Defaulting to  200.
  ...
  Threshold for basis singularities not db.
  ...
  | At each grid point, the db of atoms used to build the partition table is smoothly restricted to
  ...
  Angular momentum expansion for Kerker preconditioner not db explicitly.
  ...
  Using default: charge_mix_param =     0.0500.
  No q(lm)/r^(l+1) cutoff db for long-range Hartree potential.
...
------------------------------------------------------------
  ...
  Number of empty states per atom not db in control.in - providing a guess from actual geometry.
...
------------------------------------------------------------
  ...
  Creating fixed part of basis db: Ionic, confined, hydrogenic.
...
------------------------------------------------------------
  ...
  | Species        1: outer_partition_radius db to              5.555717568450569 AA .
  | Species        2: Confinement radius =              4.999999999999999 AA, multipole_radius_free =              5.048384829883283 AA.
  | Species        2: outer_partition_radius db to              5.048384829883283 AA .
